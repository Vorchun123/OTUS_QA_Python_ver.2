...
def test_check_element_on_main_page(browser):
    ...
    main_page.checking_color_button_subscribe()
...
def test_check_element_in_catalog(browser):
    ...
    catalog_page.checking_count_subcategories()
...
def test_check_element_on_page_of_register(browser):
    ...
    registration_page.checking_name_button_save()
    registration_page.clickable_button_create_your_account()
    registration_page.checking_color_button_save()
    registration_page.checking_name_button_show()
